...
run_simulator() {
  ...
  local SIMULATION_INSTRUCTIONS_FOLDER=rowhammder_dev/baseline_bingo
  ...
  ${SIMULATOR} --warmup_instructions ${WARMUP_INSTRUCTIONS} -i 500000000   "${TRACE_FILE}" > "${RESULTS_DIR}/${TRACE_FILENAME}.out"
}
